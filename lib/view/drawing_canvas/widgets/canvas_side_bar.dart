...
import 'package:appdevelopmentapplications_aaysha/view/drawing_canvas/widgets/color_palette.dart';
  ...
  void saveFile(Uint8List bytes, String extension) async {
    if (kIsWeb) {
      html.AnchorElement()
        ...
        ..download =
            'appDevelopmentApplications-main-${DateTime.now().toIso8601String()}.$extension'
        ..style.display = 'none'
        ..click();
    } else {
